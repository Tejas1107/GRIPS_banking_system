...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "insert into users(name,email,pnumber,balance) values('{$name}','{$email}','{$phone}','{$balance}')";
    ...
    <h1 style="text-decoration:underline;color:#0a6ea8;text-align:center;padding-top:20px;padding-bottom:20px;">Create User</h1>
                ...
                <div class="screen-body">
                    ...
                    <div class="screen-body-item">
                        <form class="app-form" method="post">
                            ...
                            <div class="app-form-group">
                                <input class="app-form-control" placeholder="PHONE NUMBER" type="number" name="pnumber" required>
                            </div>
                            <div class="app-form-group">
